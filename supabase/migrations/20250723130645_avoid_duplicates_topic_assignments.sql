...
CREATE UNIQUE INDEX unique_source_table_id_pair ON public.meeting_topic_assignments USING btree (source_id, source_table);

alter table "public"."meeting_topic_assignments" add constraint "unique_source_table_id_pair" UNIQUE using index "unique_source_table_id_pair";
